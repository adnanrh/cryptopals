...
public class SetOneTest {
    ...
    public void challenge_one() throws Exception {
        ...
        String actual = CommonFunctions.hexToBase64("49276d206b696c6c696e6720796f757220627261696e206c696b65206120706f69736f6e6f7573206d757368726f6f6d");
    ...
    public void challenge_two() throws Exception {
        ...
        String actual = CommonFunctions.hexXor("1c0111001f010100061a024b53535009181c", "686974207468652062756c6c277320657965");
        assertEquals(expected, actual);
    }
    ...
    public void challenge_three() throws Exception {
        ...
        List<String> response = CommonFunctions.findSingleXorCipherAndMessage("1b37373331363f78151b7f2b783431333d78397828372d363c78373e783a393b3736");
    ...
    public void challenge_four() throws Exception {
        ...
        List<String> response = CommonFunctions.findEncryptedStringFromFile("files/4.txt");
    ...
    public void challenge_five() throws Exception {
        ...
        String actualEncrypted = CommonFunctions.encryptWithRepeatingKeyXor(message, key);
    ...
    public void hamming_distance_test() throws Exception {
        ...
        int hd = CommonFunctions.getHammingDistance(a, b);
        assertEquals(37, hd);
    }
}
